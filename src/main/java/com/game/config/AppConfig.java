...
//        properties.put("hibernate.show_sql", true); // Mark as true to log hibernate queries
//        properties.put("hibernate.format_sql", true); // Mark as true to log hibernate queries
